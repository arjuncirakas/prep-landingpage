      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          >
            ...
            <motion.a 
              href="#watch" 
              className='border-2 border-[#4A9B8E] text-[#4A9B8E] bg-white px-3 sm:px-4 md:px-6 py-2 sm:py-2.5 rounded-full flex items-center justify-between hover:bg-[#4A9B8E] hover:text-white transition-all duration-300 text-[1rem] font-medium w-[200px] sm:w-[200px] md:w-[220px] lg:w-[220px] group'
              whileHover={{ 
                scale: 1.05,
                y: -2
              }}
